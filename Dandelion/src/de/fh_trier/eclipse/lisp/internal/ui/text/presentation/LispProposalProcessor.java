...
import de.fh_trier.eclipse.lisp.internal.ui.editor.ILispEditor;
...
implements IContentAssistProcessor 
{
	...
	{	
		...
		ISymbolStore store = LispCore.getEvalServerManager().getSymbolStoreFor(fEditor.getInput().getProject());
