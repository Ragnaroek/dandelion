 ...
 *
 */
public class LispProjectPreferences 
{
	 ...
	 * @param evalServer - Der zu speicherenden Server
	 * @throws CoreException - wenn Projekt geschlossen
	 */
	public static void storeEvalServer(final IProject project, final IEnvironment evalServer)
	throws CoreException
	{
		project.setPersistentProperty(HOST, evalServer.getHost());
		project.setPersistentProperty(PORT, Integer.toString(evalServer.getPort()));
		project.setPersistentProperty(NAME, evalServer.getName());
		project.setPersistentProperty(VERSION, evalServer.getVersion());
	}
	 ...
	 * @throws CoreException - wenn Projekt geschlossen
	 */
	public static IEnvironment readEvalServer(final IProject project)
	throws CoreException
	{
		try {
