...
import de.fh_trier.eclipse.lisp.internal.preferences.LispServerPreferencePage;
...
implements SelectionListener
{
	...
	public LispProjectWizardPage(final String pageName) {
		super(pageName);
		fEvalServerManager = LispCore.getEvalServerManager();
	}
	...
	public boolean isPageComplete() {
		return super.isPageComplete() && fEvalServerManager.hasEvalServer();
	}
	...
	public IEnvironment getSelectedEvalServer()
	{
		...
		if( fChooseRadio.getSelection() ) {
			...
			selection = fEvalServerManager.getDefaultEvalServer();
		}
	...
	protected void updateEvalServer()
	{
		...
		if( !fEvalServerManager.hasEvalServer() ) {
			...
			text += fEvalServerManager.getDefaultEvalServer().toString();
		}
	...
	{
		if( !fEvalServerManager.hasEvalServer() ) { //kein einziger Server angeben
