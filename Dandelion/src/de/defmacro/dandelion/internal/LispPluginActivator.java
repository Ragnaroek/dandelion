...
extends AbstractUIPlugin 
{
	...
	public void start(final BundleContext context) throws Exception {
		...
		LispCore.getEnvironmentManager().initialize();
		LispCore.getProjectManager().initialize();
	}
	...
	public void stop(final BundleContext context) throws Exception {
		try {
			LispUI.dispose();
			LispCore.getEnvironmentManager().dispose();
		} finally {
			plugin = null;
			super.stop(context);
		}
	...
	{
		return AbstractUIPlugin.imageDescriptorFromPlugin(ID, imgSpec);
	}
}
